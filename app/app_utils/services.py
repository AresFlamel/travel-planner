...
def get_memory_service():
    ...
    project_id = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-6a88f0f41795")
    location = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION") or os.environ.get(
        "GOOGLE_CLOUD_LOCATION", "us-east1"
    )
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", "247972857412321280")
